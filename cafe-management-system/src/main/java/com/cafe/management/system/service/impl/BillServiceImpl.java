...
public class BillServiceImpl implements BillService {
    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        try {
            ...
            if (validateRequestMap(requestMap)) {
                ...
                JSONArray jsonArray = CafeUtils.getJSONOArrayFromString((String) requestMap.get("productDetails"));
    ...
    private void addTableHeader(PdfPTable table) {
        log.info("Inside addTablleHeader");
    ...
    private void insertBill(Map<String, Object> requestMap) {
        try {
            ...
            log.info("productDetails{}", (String) requestMap.get("productDetails"));
    ...
    public ResponseEntity<byte[]> getPdf(Map<String, Object> requestMap) {
        log.info("Insider getPdf : requestMap {}", requestMap);
        try {
